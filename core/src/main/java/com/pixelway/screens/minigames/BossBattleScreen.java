...
public class BossBattleScreen implements Screen {
    ...
    private static final int PHASE_ONE_THRESHOLD = 750;
    private static final int PHASE_TWO_THRESHOLD = 500;
    ...
    public void show() {
        ...
        boss = new Boss(new Vector2(535, 450), 200f, 200f, bossWorldManager.getWorld(), game);
