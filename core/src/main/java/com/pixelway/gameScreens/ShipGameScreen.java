...
public class ShipGameScreen implements Screen {
    ...
    public ShipGameScreen(MainClass game, Player player, PlayerData playerData) {
        this.game = game;
    ...
    public ShipGameScreen(MainClass game, Player player, PlayerData playerData, boolean isTeleport) {
        this.game = game;
        this.worldManager = new WorldManager();
        this.player = player;
        this.playerData = playerData;
